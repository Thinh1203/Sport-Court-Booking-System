...
export class HeadquartersService {
  ...
  async updateById(
    id: number,
    headquartersData: headquartersDataUpdate,
    ...
    if (file != null) {
      await this.cloudinaryService.deleteFile(
        existingHeadquarters.imageCloudinaryId,
      );
      const fileUpload = await this.cloudinaryService.uploadFile(
        file,
        300,
        300,
      );
      return await this.prisma.headquarters.update({
        ...
        data: {
          ...
          description:
            headquartersData.description ?? existingHeadquarters.description,
          imageUrl: fileUpload.secure_url,
          imageCloudinaryId: fileUpload.public_id,
        },
      });
