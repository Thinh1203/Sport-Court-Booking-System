  ...
  schema: {
    ...
    properties: {
      ...
      discountValue: {
        type: 'number',
        example: 10,
        description: 'percentage_value: 10-20-30 or flat_value: 100000 - 200000 - 300000',
      },
      startDate: {
        type: 'string',
    ...
    required: ['code', 'description', 'isDynamic', 'discountType', 'discountValue', 'startDate', 'endDate', 'maxUsage', 'minTotalAmount', 'status', 'theSportsCenterId']
  },
});
